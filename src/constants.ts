...
export const OPENCLAW_SESSIONS_SUBDIR = 'sessions';
export const OPENCLAW_SESSIONS_INDEX = 'sessions.json';
export const OPENCLAW_TELEMETRY_LOG = path.join(OPENCLAW_DIR, 'logs', 'telemetry.jsonl');

// ── OpenClaw Timing ───────────────────────────────────────────
export const AGENT_IDLE_TIMEOUT_MS = 30_000;
export const AGENT_DISCOVERY_INTERVAL_MS = 15_000;
export const SESSION_ACTIVE_WINDOW_MS = 5 * 60 * 1000;

// ── Standalone Server ─────────────────────────────────────────
export const STANDALONE_PORT = 3847;
